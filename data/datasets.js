export default {
  custodialDeaths: {
    ...
    urls: {
      compressed: 'https://s3.amazonaws.com/tji-compressed-data/cdr_compressed_new.json.gz',
  ...
  civiliansShot: {
    ...
    urls: {
      compressed: 'https://s3.amazonaws.com/tji-compressed-data/ois_compressed_new.json.gz',
  ...
  officersShot: {
    ...
    urls: {
      compressed: 'https://s3.amazonaws.com/tji-compressed-data/ois_officers_compressed_new.json.gz',
